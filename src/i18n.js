...
const resources = {
  ...
  ar: { // Arabic translations
    translation: {
      ...
      "Jobsy connects talent and employers faster than ever.Post jobs or find your dream role with ease.": "يربط جوبسي المواهب وأصحاب العمل بأسرع وقت من أي وقت مضى. انشر الوظائف أو اعثر على وظيفة أحلامك بسهولة",
      ...
      "Post Jobs Instantly": "نشر الوظائف فوراً",
      "Easily post jobs and get visibility in seconds. Connect with talent quickly!": "انشر الوظائف بسهولة واحصل على رؤية في ثوانٍ. اتصل بالمواهب بسرعة!",
      "Smart Matching": "ربط ذكية",
      "Jobsy connects you with the right candidates using intelligent algorithms.": " يربطك جوبسي بالمرشحين المناسبين باستخدام خوارزميات ذكية.", 
      ...
      "At [jobsy], our mission is to support freelancers by providing a platform that connects talent with opportunity. We are proud to offer a space where independent professionals can showcase their skills, build connections, and grow their careers.": "في جوبسي , تتمثل مهمتنا في دعم المستقلين من خلال توفير منصة تربط بين المواهب والفرص. نفخر بتقديم مساحة للمحترفين المستقلين لعرض مهاراتهم، بناء العلاقات، وتنمية مسيرتهم المهني",
      "However, it’s important to clarify the nature of our role. While we facilitate discovery and connection, we are not involved in the details of any agreements, communications, payments, or outcomes between freelancers and their clients.": "ومع ذلك، من المهم توضيح طبيعة دورنا. بينما نسهل الاكتشاف والتواصل، فإننا لسنا طرفًا في تفاصيل أي اتفاقيات أو اتصالات أو مدفوعات أو نتائج بين المستقلين وعملائهم",
      "In simpler terms:": "بصورة أبسط :",
      "We are not responsible for project terms, deliverables, or payment disputes.": "لسنا مسؤولين عن شروط المشاريع، أو مخرجاتها، أو نزاعات الدفع",
      "We do not mediate conflicts or enforce contractual obligations between users.": "لا نتدخل لفض النزاعات أو فرض الالتزامات التعاقدية بين المستخدمين",
      "We provide the platform—you take charge of your business.": "نحن نوفر المنصة — وأنت تدير عملك",
      "By using this website, you acknowledge that all freelance work conducted as a result of connections made here is your responsibility to manage. We trust in your professionalism and ability to navigate your freelance relationships with integrity, clarity, and care.": "باستخدام هذا الموقع، فإنك تقر بأن جميع الأعمال الحرة التي تتم نتيجة للاتصالات التي تُجرى هنا تقع مسؤولية إدارتها عليك. نحن نثق في احترافيتك وقدرتك على إدارة علاقاتك المهنية بنزاهة ووضوح وعناية",
      "We’re honored to be a part of your journey—and while we don’t step into the spotlight with you, we’re here to keep the stage well-lit": "يشرفنا أن نكون جزءًا من رحلتك — وبينما لا نخطو إلى دائرة الضوء معك، فإننا هنا لنبقي المسرح مضيئاً لك",
      "Fun Work": "عمل ممتع",
  ...
  ku: { // Kurdish translations (Sorani dialect example)
    translation: {
      ...
      "Fun Work": "کاری  گونجاو",
      "create an account": "ئەکاونت دروست بکە",
      ...
      "At [jobsy], our mission is to support freelancers by providing a platform that connects talent with opportunity. We are proud to offer a space where independent professionals can showcase their skills, build connections, and grow their careers.": "لە [جۆبسی]، ئامانجمان پشتیوانی لە کارمەندانە کەسایەتییەکانە بەدەن بەشێوەیەکی پلاتفۆرم کە بەهێز و دەرفەت بە یەک دەگەیەنێت. فخر دەکەین بە دابینکردنی شوێنێک کە کارمەندانە کەسایەتییەکان دەتوانن توانای خۆیان نیشان بدەن، پەیوەندیدان دروست بکەن، و پەرەپێدان بەرز بکەن.",
      "However, it’s important to clarify the nature of our role. While we facilitate discovery and connection, we are not involved in the details of any agreements, communications, payments, or outcomes between freelancers and their clients.": "بەڵام، گرنگە کە جۆری کردارمان ڕوون بکەین. هەرچەندە ئێمە دابینکردنی دۆزینەوە و پەیوەندی دروست دەکەین، بەڵام لە وردەکارییەکانی هەر پەیمانێک، پەیوەندییەکان، پاراستن، یان ئەنجامی نێوان کارمەندان و کڕیارانیاندا بەشدار نین.",
      "In simpler terms:": "بە وشەیەکی سادەدا:",
      "We are not responsible for project terms, deliverables, or payment disputes.": "نەمان پێشنیار دەکەین بۆ شتەکان، ئەنجامەکان، یان کێشەکانی پاراستن.",
      "We do not mediate conflicts or enforce contractual obligations between users.": "نەمان بەشدار دەبێت لە کێشەکان یان پەیوەندیدانی پەیمانەکان لە نێوان بەکارهێنەرەکاندا.",
      "We provide the platform—you take charge of your business.": "ئێمە پلاتفۆرم دابین دەکەین — تۆ کارەکەت بەدەستهێنە.",
      "By using this website, you acknowledge that all freelance work conducted as a result of connections made here is your responsibility to manage. We trust in your professionalism and ability to navigate your freelance relationships with integrity, clarity, and care.": "بە بەکارهێنانی ئەم ماڵپەڕە، تۆ پەسند دەکەیت کە هەموو کارە سەربەخۆییەکان کە بەهۆی پەیوەندییەکان لێرەدا دروست دەکرێت، بەرزکردنەوەی کارەکەت بەرز دەبێت. ئێمە سەرکەوتنی تۆ و توانای تۆ لە ڕێگەدان بە پەیوەندییە سەربەخۆکانت بە نزاهەت، ڕوونایی، و خۆشویستی پێداچون دەکین.",
      "We’re honored to be a part of your journey—and while we don’t step into the spotlight with you, we’re here to keep the stage well-lit": "بەخۆشحالییەوە بەشداربوونی لە ڕێگایەکەتدا هەریم — و هەرچەندە لە سەر سەکۆت نین، ئێمە لێرەی ئێوەیە بۆ ئەوەی سەر سەکۆت بە شێوەیەکی خۆش بێت.",
      
      "Post Jobs Instantly": "راستەوخۆ کار بڵاو بکەرەوە",
      "Easily post jobs and get visibility in seconds. Connect with talent quickly!": "بە ئاسانی کار بڵاو بکەرەوە و لە چەند چرکەیەکی کەمدا و بینەرێکی زۆر. بە شێوەیەکی خێرا پەیوەندبە بە بەهرەداران!",
      "Smart Matching": "بەیەک گەیشتنی خێرا",
      "Jobsy connects you with the right candidates using intelligent algorithms.": "جۆبسی بە بەکارهێنانی ئالگۆریزمی زیرەک تۆ و کاندیدی شیاو بە یەک دەگەیەنێت.",
      "Real-Time Communication": "پەیوەندیدانی ڕاستەوخۆ",
      "Chat directly with applicants or clients within the platform.": "بە شێوەیەکی راستەوخۆ پەیوەندیدانی لە نێوان داواکار و خاوەن کار لە ناو پلاتفۆرمەکەدا بکە.",
      "Where Talent Meets Opportunity.": "شوێنێک کە بەهرە و دەرفەت بەیەک دەگەن.",
      "Find your next freelance opportunity or the perfect freelancer for your project. Jobsy connects talent and employers faster than ever.": "دەرفەتی کاری سەربەخۆی داهاتووت یان سەربەخۆی گونجاو بۆ پڕۆژەکەت بدۆزەرەوە. جۆبسی بەهرەمەندەکان و خاوەنکارەکان ز ووتر لە جاران پێکەوە دەبەستێتەوە.",
      ...
      "at jobsy, our mission is to support freelancers by providing a platform that connects talent with opportunity. We are proud to offer a space where independent professionals can showcase their skills, build connections, and grow their careers.": "لە جۆبسی، ئەرکی ئێمە ئەوەیە پشتیوانی لە بەهرەمەندەکان بکەین بە دابینکردنی پلاتفۆرمێک کە بەهرەمەند و دەرفەت بەیەک دەگەیەنێت. حاڵمان دەکات کە شوێنێک دابین بکەین کە پڕۆفیشنالە سەر بەخۆیان بتوانن توانای خۆیان نیشان بدەن، پەیوەندی دروست بکەن و کارەکانیان بەرز بکەن.",
      
      "Work that feels fun": "کارێک کە هەستێکی خۆشت پێدەبخشێت",
      "Explore a colorful world of job opportunities across various fields.": "بگەڕێ لە جیهانێکی ڕەنگاوڕەنگی هەلی کار لە بوارە جیاوازەکاندا .",
